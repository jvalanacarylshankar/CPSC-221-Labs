...
/*-- LQueue.h -------------------------------------------------------------
  ...
  constructor:  Constructs an empty queue
   ...
   move_to_front:   Moves a node to the front of the queue
merge_two_queues:   Merges two sorted queues into one queue
          length:   Length of the queue
   getMyFrontVal:   Value of myFront returned
...
void move_to_front(QueueElement val);
  /*-----------------------------------------------------------------------
    Moves node to front of queue (if found).

    Precondition:  Queue is nonempty.
    Postcondition: Node is moved to the front of the queue unless the queue does not contain the value given.
  -----------------------------------------------------------------------*/
...
void merge_two_queues(Queue & q2);
  /*-----------------------------------------------------------------------
    ...
    Postcondition: Queue1 has all the elements and Queue2 is empty.
  -----------------------------------------------------------------------*/
...
int length();
  /*-----------------------------------------------------------------------
    ...
    Precondition:  
    Postcondition: Returns length of queue
  -----------------------------------------------------------------------*/

int getMyFrontVal();
  /*-----------------------------------------------------------------------
    Value of myFront returned.

    Precondition:  
    Postcondition: Returns value of myFront
  -----------------------------------------------------------------------*/
